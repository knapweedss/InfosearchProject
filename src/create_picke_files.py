...
k = 2
b = 0.75
corp_path = sys.argv[1] # путь к корпусу
work_dir = sys.argv[2] # '/Users/mariadolgodvorova/PycharmProjects/InfosearchProject/
...
if __name__ == "__main__":
    ...
    create_required_files(corp_path, work_dir)
